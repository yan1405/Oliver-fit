...
Este projeto tem um design system fechado e uma auditoria anti-"cara de IA" já feita (`docs/design-tokens.json`, `docs/auditoria-design.md`, `AGENTS.md`). Esta skill aplica essas regras de forma consistente a cada tela/componente novo, em vez de reavaliar a decisão do zero toda vez.
